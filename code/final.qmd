...
## Results
We analyzed the difference between seed count at different kangroo rat mounds at the Sevilleta National Wildlife Refuge in New Mexico. The null hypothesis stated that there is no relationship between seed count and the location of kangaroo rat mounds, while the alternative hypothesis stated that there is a relationship between these two variables. 

Our analysis using a Kruskal-Wallis test and Pairwise Wilcox test showed that there is a relationship between seed count and location. The pairwise Wilcox test showed that there are significant differences between the number of seeds found at the base, edge, inter-space locations. The p-values we calculated were < 0.01, which is less than the significance level of 0.05. So, we reject the null hypothesis. 
